...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def runValueIteration(self):
        ...
        for interation in range(self.iterations):
            ...
            for state in self.mdp.getStates():
                ...
                # Otherwise, set the value to the max q value
                else:
    ...
    def computeQValueFromValues(self, state, action):
        ...
        # Iterate through the possible next states and their probabilities
        for (nextState, prob) in self.mdp.getTransitionStatesAndProbs(state, action):

            # Calculate the total q value
    ...
    def computeActionFromValues(self, state):
        ...
        return actions[qValues.index(maxQValue)]
